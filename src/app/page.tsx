    ...
    <div>
      ...
      <section className="grid md:grid-cols-3">
        ...
        <div className="relative img-container" style={{ aspectRatio: '3/4' }}>
          <Image
            src="https://images.unsplash.com/photo-1512374382149-233c42b6a83b?w=800&q=80"
            alt="KINX Clothing"
            fill
          ...
          <div className="absolute bottom-8 left-8">
            ...
            <Link href="/shop?category=clothing" className="display text-white text-3xl hover:text-accent transition-colors">
              Clothing
            </Link>
          </div>
        </div>
        ...
        <div className="relative img-container" style={{ aspectRatio: '3/4' }}>
          <Image
            src="https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=800&q=80"
            alt="KINX Hats"
            fill
            className="object-cover"
            sizes="33vw"
          ...
          <div className="absolute bottom-8 left-8">
            ...
            <Link href="/shop?category=hats" className="display text-white text-3xl hover:text-accent transition-colors">
              Hats
            </Link>
          </div>
        </div>
        ...
        <div className="relative img-container" style={{ aspectRatio: '3/4' }}>
          <Image
            src="https://images.unsplash.com/photo-1614854262318-831574f15f1f?w=800&q=80"
            alt="KINX Keychains"
            fill
            className="object-cover"
            sizes="33vw"
          ...
          <div className="absolute bottom-8 left-8">
            ...
            <Link href="/shop?category=keychains" className="display text-white text-3xl hover:text-accent transition-colors">
              Keychains
            </Link>
          </div>
        </div>
      ...
      <section className="bg-ink text-paper py-24 px-6 text-center">
        <p className="display text-paper/80 mx-auto"
          ...
          &ldquo;The streets are your runway&nbsp;—
          <em>wear it like you mean it.</em>&rdquo;
        </p>
      </section>
